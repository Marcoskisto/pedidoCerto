            ...
            <table class="table table-striped table bordered table-hover" >
                ...
                <tbody>
                    ...
                    <!--Botão de detalhes do registro-->
                        <a href="{{ route('comanda.show', $comanda) }}" class="btn btn-xs btn-primary">
                    ...
                    <!--Botão de exclução do registro-->
                        <form action="{{ route('comanda.destroy', $comanda) }}" method="post" onsubmit="return confirm('Voce tem certeza de que quer excluir este registro ?');"
